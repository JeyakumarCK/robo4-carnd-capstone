...
flags.DEFINE_string('label_map_path', 'data/UTL_label_map.pbtxt',
...
def dict_to_tf_example(data,
  ...
  w,h = image.size
  print(w,h)
  image_resized = image.resize((500,500), PIL.Image.ANTIALIAS)
  ...
  for obj in data['object']:
    ...
    print("Label",label_map_dict[class_name])
...
def create_tf_record(output_filename,
  ...
  for idx, example in enumerate(examples):
    ...
    print("in CTF: data",data)
    tf_example = dict_to_tf_example(data, label_map_dict, image_dir)
    #print("in CTF: tf_example",tf_example)
